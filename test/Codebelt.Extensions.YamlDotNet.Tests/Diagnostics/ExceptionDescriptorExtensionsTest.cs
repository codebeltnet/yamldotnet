...
namespace Codebelt.Extensions.YamlDotNet.Diagnostics
{
  ...
  Failure:
    ...
    Stack:
      - at Codebelt.Extensions.YamlDotNet.Diagnostics.ExceptionDescriptorExtensionsTest.ToYaml_ShouldReturnDetailedExceptionString_WithAllCaptures()".ReplaceLineEndings(), sut2);
      ...
      Name: Cuemon".ReplaceLineEndings(), sut2);
            ...
            Assert.Contains("""
                            Evidence:
                              Thrower:
                                MemberSignature: Codebelt.Extensions.YamlDotNet.Diagnostics.ExceptionDescriptorExtensionsTest.ToYaml_ShouldReturnDetailedExceptionString_WithAllCaptures()
                                RuntimeParameters: {}
  ...
  Thrower:
    MemberSignature: Codebelt.Extensions.YamlDotNet.Diagnostics.ExceptionDescriptorExtensionsTest.ToYaml_ShouldReturnDetailedExceptionString_WithCaptures_MakeUseOfIncludeOptions(ExceptionDescriptorOptions options, SystemSnapshots snapshots)
    RuntimeParameters:
  ...
  Thrower:
    ...
    Message: Insufficient memory to continue the execution of the program.".ReplaceLineEndings(), sut2);
      ...
      - at Codebelt.Extensions.YamlDotNet.Diagnostics.ExceptionDescriptorExtensionsTest.ToYaml_ShouldReturnDetailedExceptionString_WithCaptures_MakeUseOfIncludeOptions(ExceptionDescriptorOptions options, SystemSnapshots snapshots)".ReplaceLineEndings(), sut2);
            }, () =>
            {
